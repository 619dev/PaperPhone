...
🌐 **Другие языки / Other Languages:** [中文](README_CN.md) · [English](README_EN.md) · [日本語](README_JA.md) · [한국어](README_KO.md) · [Français](README_FR.md) · [Deutsch](README_DE.md) · [Español](README_ES.md)
...
| `group_invites` | Ссылки-приглашения в группы (со сроком действия, для QR-кодов) |
